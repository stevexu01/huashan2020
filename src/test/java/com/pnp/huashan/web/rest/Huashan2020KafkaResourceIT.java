...
import com.pnp.huashan.config.KafkaProperties;
...
class Huashan2020KafkaResourceIT {
    ...
    void setup() {
        ...
        Huashan2020KafkaResource kafkaResource = new Huashan2020KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/huashan-2020-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/huashan-2020-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
