...
@RestController
@RequestMapping("/api/huashan-2020-kafka")
public class Huashan2020KafkaResource {
    private final Logger log = LoggerFactory.getLogger(Huashan2020KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Huashan2020KafkaResource(KafkaProperties kafkaProperties) {
